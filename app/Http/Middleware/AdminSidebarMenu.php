                ...
                $menu->dropdown(
                    ...
                    function ($sub) {
                        ...
                        if (auth()->user()->can('customer.view')) {
                            ...
                            $sub->url(
                                action('ContactController@index', ['type' => 'guarantor']),
                                __('report.guarantor'),
                                ['icon' => 'fa fas fa-star', 'active' => request()->input('type') == 'guarantor']
                            );
                            /* $sub->url(
                        ...
                        if (
                            auth()->user()->can('supplier.create') || auth()->user()->can('customer.create')

    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <?php echo Form::select('app_currency_id', $currencies, 18, ['class' => 'form-control select2','placeholder' => __('business.currency_placeholder'), 'required']); ?>
...
</div><?php /**PATH F:\Nova pasta\gestao\Modules\Superadmin\Providers/../Resources/views/superadmin_settings/partials/super_admin_settings.blade.php ENDPATH**/ ?>
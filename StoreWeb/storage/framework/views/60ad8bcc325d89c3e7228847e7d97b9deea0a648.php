...
<div class="col-md-3">
    <div class="form-group">
        <div class="checkbox">
            <label>
                <br>
              <?php echo Form::checkbox('ecommerce', 1, false, 
              [ 'class' => 'input-icheck', 'id' => 'ecommerce']); ?> Ecommerce
            </label>
        </div>
    </div>
</div><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/sell/partials/sell_list_filters.blade.php ENDPATH**/ ?>
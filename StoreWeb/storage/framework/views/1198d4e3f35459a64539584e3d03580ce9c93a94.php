        ...
        <div class="col-sm-4">
          <div class="form-group">
            <?php echo Form::label('closing_amount', __( 'cash_register.total_cash' ) . ':*'); ?>
              ...
              <?php echo Form::text('closing_amount', number_format($register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund, 2, ',', '.'), ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'cash_register.total_cash' ) ]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/cash_register/close_register_modal.blade.php ENDPATH**/ ?>
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
				<div class="form-group">
					...
					<?php echo Form::select('status', ['final' => 'Final', 'draft' => __('sale.draft'), 'quotation' => __('lang_v1.quotation')], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); ?>
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<?php echo Form::select('natureza_id', $naturezas, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); ?>
...
<?php echo $__env->renderComponent(); ?>
			...
			<?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => 'Produtos da Venda']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/sell/create.blade.php ENDPATH**/ ?>
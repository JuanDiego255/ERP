		...
		<div class="col-md-4 col-sm-6">
			<div class="form-group">
				<div class="input-group">
					...
					<?php echo Form::text('exchange_rate', number_format($transaction->exchange_rate, 2, ',', '.'), ['class' => 'form-control input-sm input_number', 'placeholder' => __('lang_v1.currency_exchange_rate'), 'id' => 'exchange_rate']); ?>
...
</div><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/sale_pos/partials/pos_form_edit.blade.php ENDPATH**/ ?>
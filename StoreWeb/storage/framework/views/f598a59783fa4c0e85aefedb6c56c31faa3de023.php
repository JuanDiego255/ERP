...
<?php echo $__env->renderComponent(); ?>
      ...
      <div class="box <?php if(!empty($class)): ?> <?php echo e($class, false); ?> <?php else: ?> box-primary <?php endif; ?>" id="accordion">
        ...
        <div id="collapseFilter" class="panel-collapse active <?php if(!$product->ecommerce): ?> collapse <?php endif; ?>" aria-expanded="true">
          <div class="box-body">
            <div class="row">
              <div class="col-sm-2">
                <div class="form-group">
                  <br>
                  <label>
                    <?php echo Form::checkbox('ecommerce', 1, $product->ecommerce, ['class' => 'input-icheck']); ?> <strong>Ecommerce</strong>
                  </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <br>
                  <label>
                    <?php echo Form::checkbox('destaque', 1, $product->destaque, ['class' => 'input-icheck']); ?> <strong>Destaque</strong>
                  </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <br>
                  <label>
                    <?php echo Form::checkbox('novo', 1, $product->novo, ['class' => 'input-icheck']); ?> <strong>Novo</strong>
                  </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <?php echo Form::text('weight', $product->weight, ['class' => 'form-control', 'placeholder' => __('lang_v1.weight'), 'data-mask="000000,000"', 'data-mask-reverse="true"']); ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input class="form-control" value="<?php echo e($product->perc_icms, false); ?>" data-mask="00.00" placeholder="%ICMS" name="perc_icms" type="text" id="perc_icms">
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            <label for="product_custom_field2">%PIS:</label>
            <input class="form-control" value="<?php echo e($product->perc_pis, false); ?>" data-mask="00.00" placeholder="%PIS" name="perc_pis" type="text" id="perc_pis">
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            <label for="product_custom_field2">%COFINS:</label>
            <input class="form-control" value="<?php echo e($product->perc_cofins, false); ?>" data-mask="00.00" placeholder="%COFINS" name="perc_cofins" type="text" id="perc_cofins">
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            <label for="product_custom_field2">%IPI:</label>
            <input class="form-control" value="<?php echo e($product->perc_ipi, false); ?>" data-mask="00.00" placeholder="%IPI" name="perc_ipi" type="text" id="perc_ipi">
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input required value="<?php echo e($product->cfop_interno, false); ?>" required class="form-control" data-mask="0000" placeholder="CFOP Estadual" name="cfop_interno" type="text" id="cfop_interno">
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input required value="<?php echo e($product->cfop_externo, false); ?>" required class="form-control" data-mask="0000" placeholder="CFOP Inter estadual" name="cfop_externo" type="text" id="cfop_externo">
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input required value="<?php echo e($product->ncm, false); ?>" required class="form-control" data-mask="0000.00.00" placeholder="NCM" name="ncm" type="text" id="ncm">
          </div>
        </div>
        ...
        <div class="veiculo" style="display: none">
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              <?php echo Form::text('cCor', $product->cCor, ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              <?php echo Form::label('cCorDENATRAN', 'Cor' . ':'); ?><br>
          ...
          <div class="col-sm-3">
            <div class="form-group">
              <?php echo Form::label('tpRest', 'Tipo de restrição' . ':'); ?><br>
              <?php echo Form::select('tpRest', App\Models\Veiculo::restricoes(), $product->tpRest, ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/product/edit.blade.php ENDPATH**/ ?>
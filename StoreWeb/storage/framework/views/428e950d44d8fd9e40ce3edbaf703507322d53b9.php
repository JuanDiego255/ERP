<?php $__env->startSection('title', 'Lista de NFCe'); ?>
...
<section class="content">
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => 'NFCe Lista']); ?>
        ...
        <div class="row">
            <div class="col-sm-2 col-lg-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control start-date-picker" placeholder="Data inicial" value="<?php echo e(isset($data_inicio) ? $data_inicio : ''); ?>" data-mask="00/00/0000" name="data_inicio" type="text" id="">
                    </div>
            ...
            <div class="col-sm-2 col-lg-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input class="form-control start-date-picker" placeholder="Data final" data-mask="00/00/0000" name="data_final" type="text" value="<?php echo e(isset($data_final) ? $data_final : ''); ?>">
                    </div>
        ...
        <table class="table table-bordered table-striped" id="users_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($n->numero_nfce, false); ?></td>
                    <td><?php echo e(number_format($n->total_before_tax, 2), false); ?></td>
                    <td><?php echo e($n->chave, false); ?></td>
                    <td><?php echo e($n->estado, false); ?></td>
                    <td>
                        <?php if($n->estado == 'APROVADO'): ?>
                        <a title="Baixar XML Aprovado" target="_blank" href="/nfce/baixarXml/<?php echo e($n->id, false); ?>">
                            <i class="fa fas fa-arrow-circle-down text-success"></i>
                        </a>

                        <a title="Imprimir" target="_blank" href="/nfce/imprimir/<?php echo e($n->id, false); ?>">
                            <i class="fa fa-print" aria-hidden="true"></i>
                        </a>
                        <?php elseif($n->estado == 'CANCELADO'): ?>
                        <a title="Baixar XML Cancelado" target="_blank" href="/nfce/baixarXmlCancelado/<?php echo e($n->id, false); ?>">
                            <i class="fa fas fa-arrow-circle-down text-danger"></i>
                        </a>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/nfce/lista.blade.php ENDPATH**/ ?>
                ...
                <tr>
                    <td>
                        ...
                        <div class="col-sm-6">
                          ...
                          <?php echo Form::text('single_dpp', number_format($variation->default_purchase_price, 2, ',', ''), ['class' => 'form-control input-sm dpp input_number', 'placeholder' => __('product.exc_of_tax'), 'required']); ?>
                        ...
                        <div class="col-sm-6">
                          ...
                          <?php echo Form::text('single_dpp_inc_tax', number_format($variation->dpp_inc_tax, 2, ',', ''), ['class' => 'form-control input-sm dpp_inc_tax input_number', 'placeholder' => __('product.inc_of_tax'), 'required']); ?>
                    ...
                    <td>
                        ...
                        <?php echo Form::text('single_dsp', ($variation->default_sell_price), ['class' => 'form-control input-sm', 'placeholder' => __('product.exc_of_tax'), 'id' => 'single_dsp', 'required']); ?>
...
</div><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/product/partials/edit_single_product_form_part.blade.php ENDPATH**/ ?>
...
<tr>
	...
	<td>
		<div class="input-group">
		  <?php echo Form::text('stocks[' . $key . '][' . $variation->id . '][' . $sub_key . '][quantity]', number_format($qty, 2, ',', '') , ['class' => 'form-control input-sm input_number purchase_quantity input_quantity', 'required', 'data-mask="0000000.00', 'data-mask-reverse="true"']); ?>
...
<td>
	<?php echo Form::text('stocks[' . $key . '][' . $variation->id . '][' . $sub_key . '][purchase_price]', number_format($purcahse_price, 2, ',', '.') , ['class' => 'form-control input-sm input_number unit_price', 'required', 'data-mask="0000000.00"', 'data-mask-reverse="true"']); ?>
...
<?php endif; ?>
	<td>
		<span class="row_subtotal_before_tax"><?php echo e(number_format($row_total, 2, ',', '.'), false); ?></span>
	</td>
	...
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<tr>
									...
									<td><strong><?php echo app('translator')->get( 'lang_v1.total_amount_exc_tax' ); ?>: </strong> <span id="total_subtotal"><?php echo e(number_format($subtotal, 2, ',', '.'), false); ?></span>
...
</div><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/opening_stock/form-part.blade.php ENDPATH**/ ?>
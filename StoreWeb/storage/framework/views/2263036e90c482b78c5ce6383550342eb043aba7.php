        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <?php echo Form::text('name', null, ['id' => 'name', 'class' => 'form-control featured-field','placeholder' => 'Razão social', 'required']); ?>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <?php echo Form::text('landline', null, ['class' => 'form-control', 'placeholder' => 'Fixo']); ?>
...
<?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/contact/create.blade.php ENDPATH**/ ?>
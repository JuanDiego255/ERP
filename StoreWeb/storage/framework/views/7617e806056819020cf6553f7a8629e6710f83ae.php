<?php $__env->startSection('title', 'Manter NFC-e'); ?>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        <h4>Número NFC-e: <strong><?php echo e($transaction->numero_nfce, false); ?></strong></h4>
      ...
      <input type="hidden" id="numero_nfce" value="<?php echo e($transaction->numero_nfce, false); ?>" name="">
      
      <div class="clearfix"></div>


      <div class="col-md-12">
        <a class="btn btn-lg btn-primary" target="_blank" href="/nfce/imprimir/<?php echo e($transaction->id, false); ?>" id="submit_user_button">Imprimir</a>
        <a class="btn btn-lg btn-info" target="_blank" href="/nfce/baixarXml/<?php echo e($transaction->id, false); ?>" id="submit_user_button">Baixar XML</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/nfce/ver.blade.php ENDPATH**/ ?>
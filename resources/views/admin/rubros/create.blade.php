...
@section('title', __('Agregar rubro'))

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>@lang('Agregar rubro')</h1>
    </section>

    <!-- Main content -->
    <section class="content">
        {!! Form::open(['url' => action('RubrosController@store'), 'method' => 'post', 'id' => 'user_add_form']) !!}
        <div class="row">
            <div class="col-md-12">
                @component('components.widget')
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('Rubro')]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('alias', __('Alias') . ':*') !!}
                            {!! Form::text('alias', null, ['class' => 'form-control', 'required', 'placeholder' => __('Alias')]) !!}
                        </div>
                    </div>

      ...
      {{--   <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('cst_csosn_padrao', $listaCSTCSOSN, $business->cst_csosn_padrao, [
                        'class' => 'form-control',
                        'required',
        ...
        {{-- <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('cst_pis_padrao', $listaCST_PIS_COFINS, $business->cst_pis_padrao, [
                        'class' => 'form-control',
                        'required',
                        'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add',
                        'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0',
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('cst_cofins_padrao', $listaCST_PIS_COFINS, $business->cst_cofins_padrao, [
                        'class' => 'form-control',
                        'required',
                        'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add',
                        'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0',
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('cst_ipi_padrao', $listaCST_IPI, $business->cst_ipi_padrao, [
                        'class' => 'form-control',
                        'required',
                        'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add',
                        'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('perc_icms_padrao', $business->perc_icms_padrao, [
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('perc_pis_padrao', $business->perc_pis_padrao, [
                        'class' => 'form-control text-uppercase',
                        'data-mask="00.00"',
                        'data-mask-reverse="true"',
                    ]) !!}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('perc_cofins_padrao', $business->perc_cofins_padrao, [
                        'class' => 'form-control text-uppercase',
                        'data-mask="00.00"',
                        'data-mask-reverse="true"',
                    ]) !!}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('perc_ipi_padrao', $business->perc_ipi_padrao, [
                        'class' => 'form-control text-uppercase',
                        'data-mask="00.00"',
                        'data-mask-reverse="true"',
                    ]) !!}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('ncm_padrao', $business->ncm_padrao, [
                        'class' => 'form-control text-uppercase',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('cfop_saida_estadual_padrao', $business->cfop_saida_estadual_padrao, [
                        'class' => 'form-control text-uppercase',
                        'data-mask="0000"',
                    ]) !!}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="">
                    {!! Form::text('cfop_saida_inter_estadual_padrao', $business->cfop_saida_inter_estadual_padrao, [
                        'class' => 'form-control text-uppercase',
                        'data-mask="0000"',
                    ]) !!}

      ...
      <div class="row">
        ...
        <div class="col-md-4 ">
          <div class="form-group">
            ...
            <input class="form-control" value="{{$contact->city}}" required placeholder="Cantón" name="city" type="text" id="city">
          </div>
        </div>
        <div class="col-md-4 ">
          <div class="form-group">
            <label for="product_custom_field2">Distrito*:</label>
            <input class="form-control" value="{{$contact->bairro}}" required placeholder="Distrito" name="bairro" type="text" id="bairro">
          </div>
        </div>
        ...
        <div class="col-md-4 ">
          <div class="form-group">
            ...
            <input class="form-control" value="{{$contact->rua}}" required placeholder="Barrio" name="rua" type="text" id="rua">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('landmark', $contact->landmark, ['class' => 'form-control', 'placeholder' => __('Dirección Exacta')]); !!}
            </div>
          </div>
        </div>

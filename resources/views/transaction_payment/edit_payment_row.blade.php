<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang('Editar adelanto')</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                @if ($transaction->type != 'opening_balance')
                    <div class="col-md-4">
                        <div class="well">
                            <strong>@lang('Factura'): </strong>{{ $transaction->ref_no }}<br>
            ...
            <div class="row payment_row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('paid_on', __('Fecha adelanto') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                            {!! Form::text('paid_on', @format_date($payment_line->vencimento), [
                                'class' => 'form-control',
                                'readonly',
                                'required',
                            ]) !!}

@extends('layouts.app')
@section('title', 'Gestionar Controles de acceso')

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Gestionar controles de acceso</h1>
    </section>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'roles.view', false, ['class' => 'input-icheck']) !!} Ver Controles de acceso
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'roles.create', false, ['class' => 'input-icheck']) !!} Crear Controles de acceso
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'roles.update', false, ['class' => 'input-icheck']) !!} Editar Controles de acceso
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'roles.delete', false, ['class' => 'input-icheck']) !!} Eliminar Controles de acceso
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'planilla.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver planilla') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'planilla.create', false, ['class' => 'input-icheck']) !!} {{ __('Crear planilla') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'planilla.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar planilla') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'planilla.delete', false, ['class' => 'input-icheck']) !!} {{ __('Eliminar planilla') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'employee.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver empleado') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'employee.create', false, ['class' => 'input-icheck']) !!} {{ __('Crear empleado') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'employee.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar empleado') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'employee.delete', false, ['class' => 'input-icheck']) !!} {{ __('Eliminar empleado') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'supplier.view', false, ['class' => 'input-icheck']) !!} {{ __('role.supplier.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'customer.view', false, ['class' => 'input-icheck']) !!} {{ __('role.customer.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'guarantor.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver fiador') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'guarantor.create', false, ['class' => 'input-icheck']) !!} {{ __('Crear fiador') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'guarantor.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar fiador') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'guarantor.delete', false, ['class' => 'input-icheck']) !!} {{ __('Eliminar fiador') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'product.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver vehículos') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'product.create', false, ['class' => 'input-icheck']) !!} {{ __('Agregar vehículo') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'product.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar vehículo') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'product.delete', false, ['class' => 'input-icheck']) !!} {{ __('Eliminar vehículo') }}
                            </label>
                        </div>
                    </div>
                    {{--  <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'cxp.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver cuentas') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'cxp.create', false, ['class' => 'input-icheck']) !!} {{ __('Agregar cuentas') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'cxp.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar cuentas') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'cxc.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver cuentas') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'cxc.create', false, ['class' => 'input-icheck']) !!} {{ __('Agregar cuentas') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'cxc.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar cuentas') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'plan_venta.view', false, ['class' => 'input-icheck']) !!} {{ __('Ver planes de venta') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'plan_venta.create', false, ['class' => 'input-icheck']) !!} {{ __('Agregar plan de venta') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'plan_venta.update', false, ['class' => 'input-icheck']) !!} {{ __('Editar plan de venta') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'report.audit', false, ['class' => 'input-icheck']) !!} {{ __('Reporte Auditorias') }}
                            </label>
                        </div>
                    </div>
                </div>

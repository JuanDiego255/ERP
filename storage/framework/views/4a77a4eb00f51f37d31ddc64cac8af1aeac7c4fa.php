      ...
      <div class="col-md-5">
        <div class="form-group">
          <?php echo Form::label('last_name', 'Sobre nome' . ':'); ?>
            ...
            <?php echo Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => 'Sobre nome' ]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH F:\Nova pasta\gestao\resources\views/sales_commission_agent/create.blade.php ENDPATH**/ ?>
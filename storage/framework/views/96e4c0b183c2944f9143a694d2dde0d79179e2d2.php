        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <?php echo Form::text("amount", number_format($payment_line->amount, 2, ',', '.'), ['class' => 'form-control input_number', 'required', 'placeholder' => 'Amount', 'data-rule-max-value' => $payment_line->amount, 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/transaction_payment/pay_supplier_due_modal.blade.php ENDPATH**/ ?>
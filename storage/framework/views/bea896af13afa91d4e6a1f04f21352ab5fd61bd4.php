      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php echo Form::select('ambiente', ['1' => 'Produção', '2' => 'Homologação'], $location->ambiente, ['class' => 'form-control select2', 'required']); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/business_location/edit.blade.php ENDPATH**/ ?>
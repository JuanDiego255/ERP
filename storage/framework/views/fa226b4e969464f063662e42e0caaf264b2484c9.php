    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        <div class="form-group">
          <?php echo Form::label('razao_social', 'Razão Social' . ':*'); ?>

          <?php echo Form::text('razao_social', null, ['class' => 'form-control', 'required', 'placeholder' => 'Razão Social' ]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Nova pasta\gestao\resources\views/transportadoras/register.blade.php ENDPATH**/ ?>
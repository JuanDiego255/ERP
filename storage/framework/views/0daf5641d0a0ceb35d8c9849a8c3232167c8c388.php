...
<!-- Main Header -->
      ...
      <div class="navbar-custom-menu">
        ...
        <?php if(in_array('pos_sale', $enabled_modules)): ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sell.create')): ?>
            <a href="<?php echo e(action('SellPosController@create'), false); ?>" title="PDV" data-toggle="tooltip" data-placement="bottom" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10">
  ...
  </header><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>
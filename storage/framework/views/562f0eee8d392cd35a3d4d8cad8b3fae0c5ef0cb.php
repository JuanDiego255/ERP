    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <?php echo Form::select('ambiente', ['1' => 'Produção', '2' => 'Homologado'], $business->ambiente, ['class' => 'form-control select2', 'required']); ?>
...
<?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/business/partials/settings_business.blade.php ENDPATH**/ ?>
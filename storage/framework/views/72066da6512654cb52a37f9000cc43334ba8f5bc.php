...
<section class="content">
    ...
    <div class="row">
        ...
        <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
            ...
            <div class="col-md-5">
                <div class="form-group">
                  <?php echo Form::label('last_name', 'Sobre nome' . ':'); ?>

                    <?php echo Form::text('last_name', $user->last_name, ['class' => 'form-control', 'placeholder' => 'Sobre nome' ]); ?>
...
<?php echo $__env->renderComponent(); ?>
        ...
        <?php $__env->startComponent('components.widget', ['title' => __('lang_v1.roles_and_permissions')]); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <?php echo Form::label('password', 'Senha' . ':'); ?>
                    ...
                    <?php echo Form::password('password', ['class' => 'form-control', 'placeholder' => 'Senha', 'required' => empty($user->allow_login) ? true : false ]); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <?php echo Form::label('role', 'Nível de acesso:*'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
...
<?php echo $__env->renderComponent(); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                ...
                ?>
                    <?php echo Form::text('cmmsn_percent', !empty($user->cmmsn_percent) ? number_format($user->cmmsn_percent, 2, ',', '.') : 0, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.cmmsn_percent' )]); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <?php echo Form::label('max_sales_discount_percent', 'Porcentagem de desconto máximo de vendas' . ':'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . 'Porcentagem máxima de desconto que um usuário pode dar durante a venda. Deixe em branco sem restrições' . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                    <?php echo Form::text('max_sales_discount_percent', !is_null($user->max_sales_discount_percent) ? number_format($user->max_sales_discount_percent, 2, ',', '.') : null, ['class' => 'form-control input_number', 'placeholder' => 'Porcentagem de desconto máximo de vendas' ]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Nova pasta\gestao\resources\views/manage_user/edit.blade.php ENDPATH**/ ?>
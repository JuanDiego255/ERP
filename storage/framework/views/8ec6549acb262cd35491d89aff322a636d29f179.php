    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <?php echo Form::select('app_currency_id', $currencies, 27, ['class' => 'form-control select2','placeholder' => __('business.currency_placeholder'), 'required']); ?>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                 <?php echo Form::label('invoice_business_landmark', 'Referência' . ':'); ?>

                <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-map-marker"></i>
                </span>
                <?php echo Form::text('invoice_business_landmark', $settings["invoice_business_landmark"], ['class' => 'form-control','placeholder' => 'Referência','required']); ?>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <?php echo Form::text('invoice_business_zip',$settings["invoice_business_zip"], ['class' => 'form-control','placeholder' => 'CEP', 'required']); ?>
...
</div><?php /**PATH C:\xampp\htdocs\StoreWeb\Modules\Superadmin\Providers/../Resources/views/superadmin_settings/partials/super_admin_settings.blade.php ENDPATH**/ ?>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                              <td><?php echo e(\Carbon::createFromTimestamp(strtotime($payment->vencimento != null ? $payment->vencimento : $payment->paid_on))->format(session('business.date_format') . ' ' . 'H:i'), false); ?></td>
...
</div><!-- /.modal-dialog --><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/transaction_payment/show_payments.blade.php ENDPATH**/ ?>
    ...
    <table class="table table-bordered table-striped ajax_view" id="purchase_table">
        <thead>
            <tr>
                ...
                <th>Total</th>
                <th>Pagamento &nbsp;&nbsp;<i class="fa fa-info-circle text-info no-print" data-toggle="tooltip" data-placement="bottom" data-html="true" data-original-title="<?php echo e(__('messages.purchase_due_tooltip'), false); ?>" aria-hidden="true"></i></th>
...
</div><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/purchase/partials/purchase_table.blade.php ENDPATH**/ ?>
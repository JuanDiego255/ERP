        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class ="col-xs-3">
                        <h4>Ventas: <strong><?php echo e($registros['vendas'], false); ?></strong></h4>
                    </div>
                    <div class ="col-xs-3">
                        <h4>Ventas em PDV: <strong><?php echo e($registros['vendas_pdv'], false); ?></strong></h4>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\Modules\Superadmin\Providers/../Resources/views/business/show.blade.php ENDPATH**/ ?>
...
<?php echo Form::open(['url' => action('ManageUserController@store'), 'method' => 'post', 'id' => 'user_add_form' ]); ?>
      ...
      <div class="col-md-4">
        <div class="form-group">
          <?php echo Form::label('password', 'Contraseña' . ':*'); ?>
            ...
            <?php echo Form::password('password', ['class' => 'form-control', 'required', 'placeholder' => 'Contraseña' ]); ?>
  ...
  <div class="col-md-12">
    <?php $__env->startComponent('components.widget', ['title' => __('sale.sells')]); ?>
      <div class="col-md-4">
        <div class="form-group">
          <?php echo Form::label('cmmsn_percent', 'Porcentaje de comisión de ventas (%)' . ':'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
      ...
      <div class="col-md-4">
        <div class="form-group">
          <?php echo Form::label('max_sales_discount_percent', 'Porcentaje máximo de descuento en ventas' . ':'); ?> <?php
                ...
                ?>
            <?php echo Form::text('max_sales_discount_percent', null, ['class' => 'form-control input_number', 'placeholder' => 'Porcentaje máximo de descuento en ventas' ]); ?>
...
<script type="text/javascript">
  ...
  $('form#user_add_form').validate({
                ...
                messages: {
                    ...
                    email: {
                        remote: '<?php echo e(__("validation.unique", ["attribute" => "Use outro email"]), false); ?>'
                    }
                }
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/manage_user/create.blade.php ENDPATH**/ ?>
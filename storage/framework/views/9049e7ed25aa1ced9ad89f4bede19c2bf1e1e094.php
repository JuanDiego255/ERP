...
<div class="row">
	<div class="col-md-12">
		...
		<div class="col-md-4">
			...
			<p><strong>Género:</strong> <?php if(!empty($user->gender)): ?> <?php echo app('translator')->get('lang_v1.' .$user->gender); ?> <?php endif; ?></p>
			...
			<p><strong><?php echo app('translator')->get( 'lang_v1.contact_no' ); ?>:</strong> <?php echo e($user->contact_number ?? '', false); ?></p>
		</div>
		<div class="col-md-4">
...
</div><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/user/show_details.blade.php ENDPATH**/ ?>
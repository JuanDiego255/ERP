<!-- Main Footer -->
  <footer class="main-footer no-print">
    ...
    <!-- Default to the left -->
    <small>
    	<?php echo e(config('app.name', 'ultimatePOS'), false); ?> <?php echo e(config('author.app_version'), false); ?> | Copyright &copy; <?php echo e(date('Y'), false); ?> Todos os direitos reservados.
    </small>
...
</footer><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/layouts/partials/footer.blade.php ENDPATH**/ ?>
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<table class="table table-bordered table-striped table-condensed" id="product_table">
					<thead>
						<tr>
							<th class="col-sm-8"><?php echo app('translator')->get( 'barcode.products' ); ?></th>
							<th class="col-sm-4"><?php echo app('translator')->get( 'barcode.no_of_labels' ); ?></th>
						</tr>
					</thead>
					<tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/labels/show.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', __('vehiculos.vehiculos')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo app('translator')->get('vehiculos.vehiculos'); ?>
        <small><?php echo app('translator')->get('vehiculos.manage_vehiculos'); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/product/index.blade.php ENDPATH**/ ?>
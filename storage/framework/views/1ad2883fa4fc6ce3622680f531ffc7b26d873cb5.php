			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<?php echo Form::text('price', number_format($packages->price, 2), ['class' => 'form-control money input_number', 'required']); ?>
				...
				<div class="col-sm-3 ">
					<div class="checkbox">
						<label>
							<?php echo Form::checkbox('is_visible', 1, $packages->is_visible, ['class' => 'input-icheck']); ?>
					...
					<div class="col-sm-4">
						<div class="form-group">
							<div class="checkbox">
								<br>
								<label>
									<?php echo Form::checkbox('enabled_modules[]', $k, in_array($k, $enabled_modules_plan), 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\Modules\Superadmin\Providers/../Resources/views/packages/edit.blade.php ENDPATH**/ ?>
<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h3 class="modal-title"><?php echo app('translator')->get( 'cash_register.register_details' ); ?> ( <?php echo e(\Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('d-m-Y H:i'), false); ?> -  <?php echo e(\Carbon::createFromFormat('Y-m-d H:i:s', $close_time)->format('d-m-Y H:i'), false); ?> )</h3>
    </div>
...
</div><!-- /.modal-dialog --><?php /**PATH F:\Nova pasta\gestao\resources\views/cash_register/register_details.blade.php ENDPATH**/ ?>
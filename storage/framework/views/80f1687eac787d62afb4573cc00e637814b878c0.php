  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="form-group">
        <?php echo Form::label('package_id', 'Planes' . ':*'); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\xampp\htdocs\StoreWeb\Modules\Superadmin\Providers/../Resources/views/superadmin_subscription/add_subscription.blade.php ENDPATH**/ ?>
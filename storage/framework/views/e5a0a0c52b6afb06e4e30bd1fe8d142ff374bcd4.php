              ...
              <div class="row">
                <div class="col-sm-2">
                  <div class="form-group">
                    <br>
                    <label>
                      <?php echo Form::checkbox('ecommerce', 1, !(empty($duplicate_product)) ? $duplicate_product->ecommerce : false, ['class' => 'input-icheck']); ?> <strong>Ecommerce</strong>
                    </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . 'Se marcado, o produto será visível no ecommerce' . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <br>
                    <label>
                      <?php echo Form::checkbox('destaque', 1, !(empty($duplicate_product)) ? $duplicate_product->destaque : false, ['class' => 'input-icheck']); ?> <strong>Destaque</strong>
                    </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . 'Se marcado, o produto será mostrado na primeira pagina' . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <br>
                    <label>
                      <?php echo Form::checkbox('novo', 1, !(empty($duplicate_product)) ? $duplicate_product->novo : false, ['class' => 'input-icheck']); ?> <strong>Novo</strong>
                    </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . 'Se marcado, o produto será mostrado como novidade' . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <?php echo Form::label('valor_ecommerce',  'Valor ecommerce' . ':'); ?>
        ...
        <div class="row">
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              <input required value="<?php echo e($business->cfop_saida_estadual_padrao, false); ?>" required class="form-control" data-mask="0000" placeholder="CFOP Estadual" name="cfop_interno" type="number" id="cfop_interno">
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              <input required value="<?php echo e($business->cfop_saida_inter_estadual_padrao, false); ?>" required class="form-control" data-mask="0000" placeholder="CFOP Inter estadual" name="cfop_externo" type="number" id="cfop_externo">
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              <input required value="<?php echo e($business->ncm_padrao, false); ?>" required class="form-control" data-mask="0000.00.00" placeholder="NCM" name="ncm" type="text" id="ncm">
            </div>
          </div>
          ...
          <div class="veiculo" style="display: none">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::text('cCor', '', ['class' => 'form-control',
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::text('pot', '', ['class' => 'form-control',
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::text('cilin', '', ['class' => 'form-control',
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::text('nSerie', '', ['class' => 'form-control',
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::select('tpComb', App\Models\Veiculo::tiposCompustivel() , '', ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::text('nMotor', '', ['class' => 'form-control',
                'placeholder' => 'Nº série']); ?>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <?php echo Form::text('CMT', '', ['class' => 'form-control',
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::text('dist', '', ['class' => 'form-control',
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::select('tpPint', App\Models\Veiculo::tiposPintura() , '', ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::select('tpVeic', App\Models\Veiculo::tipos(), '', ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::select('espVeic', App\Models\Veiculo::especies(), '', ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <?php echo Form::select('VIN', ['R' => 'Remarcado', 'N' => 'Normal'], '', ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <?php echo Form::text('lota', '', ['class' => 'form-control',
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <?php echo Form::select('tpRest', App\Models\Veiculo::restricoes(), '', ['class' => 'form-control select2', 'style' => 'width: 100%']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/product/create.blade.php ENDPATH**/ ?>
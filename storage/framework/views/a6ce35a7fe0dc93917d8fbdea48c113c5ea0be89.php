<div class="row">
	...
	<div class="<?php echo e($col_class, false); ?>">
		<div class="form-group">
			...
			<div class="input-group">
				...
				<?php echo Form::text("payment[$row_index][amount]", number_format($payment_line['amount'], 2, ',', '.'), ['class' => 'form-control payment-amount input_number', 'required', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount')]); ?>
	...
	<div class="<?php echo e($col_class, false); ?>">
		<div class="form-group">
			<?php echo Form::label("method_$row_index" , 'Forma de pago' . ':*'); ?>
	...
	<div class="col-md-12">
		<div class="form-group">
			<?php echo Form::label("note_$row_index", 'Observaciones de pago'); ?>

			<?php echo Form::textarea("payment[$row_index][note]", $payment_line['note'], ['class' => 'form-control', 'rows' => 3, 'id' => "note_$row_index"]); ?>

		</div>
	</div>
</div><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/sale_pos/partials/payment_row_form.blade.php ENDPATH**/ ?>
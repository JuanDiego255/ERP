    ...
    <div class="col-sm-8">
        <div class="box box-solid"> <!--business info box start-->
            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-6">
                    <?php echo Form::label('language', 'Linguagem' . ':'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Nova pasta\gestao\resources\views/user/profile.blade.php ENDPATH**/ ?>
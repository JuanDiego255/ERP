    ...
    <tr>
        ...
        <td>
            ...
            <?php if($product->enable_stock == 1): ?>
                <br>
                <small class="text-muted" style="white-space: nowrap;"><?php echo app('translator')->get('report.current_stock'); ?>: <?php if(!empty($variation->variation_location_details->first())): ?> <?php echo e(@number_format($variation->variation_location_details->first()->qty_available, 2, ',', '.'), false); ?> <?php else: ?> 0 <?php endif; ?> <?php echo e($product->unit->short_name, false); ?></small>
            <?php endif; ?>
        ...
        <td>
            ...
            ?>
            <?php echo Form::text('purchases[' . $row_count . '][quantity]', number_format(1, $quantity_precision, ',', ''), ['class' => 'form-control input-sm purchase_quantity input_number mousetrap', 'required', 'data-rule-abs_digit' => $check_decimal, 'data-msg-abs_digit' => __('lang_v1.decimal_value_not_allowed')]); ?>
        ...
        <td>
            <?php if(session('business.enable_editing_product_from_purchase')): ?>
                <?php echo Form::text('purchases[' . $row_count . '][default_sell_price]', number_format($variation->sell_price_inc_tax, $currency_precision, ',', ''), ['class' => 'form-control input-sm input_number default_sell_price', 'required']); ?>

            <?php else: ?>
                <?php echo e(number_format($variation->sell_price_inc_tax, $currency_precision, ',', ''), false); ?>
...
<input type="hidden" id="row_count" value="<?php echo e($row_count, false); ?>"><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/purchase/partials/purchase_entry_row.blade.php ENDPATH**/ ?>
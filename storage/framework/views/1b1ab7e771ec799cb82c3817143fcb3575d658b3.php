<?php $__env->startSection('title', __('superadmin::lang.superadmin') . ' | ' . 'Planos'); ?>
					...
					<div class="box box-success hvr-grow-shadow">
						<div class="box-header with-border text-center">
							...
							<div class="row">
								...
								<a href="<?php echo e(action('\Modules\Superadmin\Http\Controllers\PackagesController@edit', [$package->id]), false); ?>" class="btn btn-box-tool" title="Editar"><i class="fa fa-edit"></i></a>
								<a href="<?php echo e(action('\Modules\Superadmin\Http\Controllers\PackagesController@destroy', [$package->id]), false); ?>" class="btn btn-box-tool link_confirmation" title="Remover"><i class="fa fa-trash"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/Modules/Superadmin/Providers/../Resources/views/packages/index.blade.php ENDPATH**/ ?>
...
<div class="form-group col-md-3">
    <?php echo Form::label('gender', 'Género' . ':'); ?>

    <?php echo Form::select('gender', ['male' => 'Masculino', 'female' => 'Feminino', 'others' => 'Outro'], !empty($user->gender) ? $user->gender : null, ['class' => 'form-control', 'id' => 'gender', 'placeholder' => __( 'messages.please_select') ]); ?>

</div>
<div class="form-group col-md-3">
    <?php echo Form::label('marital_status', __( 'lang_v1.marital_status' ) . ':'); ?>

    <?php echo Form::select('marital_status', ['married' => 'Casado(a)', 'unmarried' => 'Solteiro(a)', 'divorced' => 'Divorciado(a)'], !empty($user->marital_status) ? $user->marital_status : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.marital_status') ]); ?>
...
</div><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/user/form.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Cuentas Por Pagar'); ?>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => 'Todas las cuentas por pagar']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/expense/index.blade.php ENDPATH**/ ?>
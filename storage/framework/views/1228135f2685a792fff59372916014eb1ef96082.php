...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			<button type="button" class="btn btn-primary btn-flat pull-right <?php if($is_mobile): ?> col-xs-6 <?php endif; ?>" data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions"> <i class="fas fa-clock"></i> Transações recentes</button>
		</div>
	</div>
</div>
...
<?php echo $__env->make('sale_pos.partials.edit_shipping_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/sale_pos/partials/pos_form_actions.blade.php ENDPATH**/ ?>
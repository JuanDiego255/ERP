      ...
      <div class="col-md-5">
        <div class="form-group">
          <?php echo Form::label('last_name', 'Apellido' . ':'); ?>
            ...
            <?php echo Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => 'Apellido' ]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/sales_commission_agent/create.blade.php ENDPATH**/ ?>
<?php echo Form::open(['url' => action('PaymentController@paymentBoleto'), 'method' => 'post', 'id' => 'form_boleto' ]); ?>
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <?php echo Form::select('Planes_id', ['' => 'Selecione o Planes'] + $Planess->pluck('info', 'id')->all(), '', ['class' => 'form-control', 'id' => 'Planes_id', 'required']); ?>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <?php echo Form::select('docType', [], '', ['class' => 'form-control', 'id' => 'docType2', 'required', 'data-checkout' => 'docType']); ?>
...
<?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/payment/_forms_boleto.blade.php ENDPATH**/ ?>
...
<section class="content">
    ...
    <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group">
                  <?php echo Form::label('last_name', 'Apellido' . ':'); ?>
                    ...
                    <?php echo Form::text('last_name', $user->last_name, ['class' => 'form-control', 'placeholder' => 'Apellido' ]); ?>
        ...
        <?php $__env->startComponent('components.widget', ['title' => __('lang_v1.roles_and_permissions')]); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <?php echo Form::label('password', 'Contraseña' . ':'); ?>
                    ...
                    <?php echo Form::password('password', ['class' => 'form-control', 'placeholder' => 'Contraseña', 'required' => empty($user->allow_login) ? true : false ]); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <?php echo Form::label('role', 'Nível de Acceso:*'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <?php echo Form::label('max_sales_discount_percent', 'Porcentaje máximo de descuento en ventas' . ':'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                ...
                ?>
                    <?php echo Form::text('max_sales_discount_percent', !is_null($user->max_sales_discount_percent) ? number_format($user->max_sales_discount_percent, 2, ',', '.') : null, ['class' => 'form-control input_number', 'placeholder' => 'Porcentaje máximo de descuento en ventas' ]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/manage_user/edit.blade.php ENDPATH**/ ?>
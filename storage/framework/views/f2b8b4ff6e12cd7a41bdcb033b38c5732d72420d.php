<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <?php echo Form::label('code', 'Código de categoría:'); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/expense_category/create.blade.php ENDPATH**/ ?>
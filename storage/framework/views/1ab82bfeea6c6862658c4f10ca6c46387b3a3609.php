<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('TaxonomyController@update', [$category->id]), 'method' => 'PUT', 'id' => 'category_edit_form', 'files' => true ]); ?>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <?php echo Form::checkbox('ecommerce', 1, $category->ecommerce, ['class' => 'input-icheck']); ?>
      ...
      <div class="form-group">
        ...
        <?php echo Form::checkbox('destaque', 1, $category->destaque, ['class' => 'input-icheck']); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/taxonomy/edit.blade.php ENDPATH**/ ?>
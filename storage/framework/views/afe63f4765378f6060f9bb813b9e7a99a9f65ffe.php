    ...
    <?php $__env->startComponent('components.filters', ['title' => __('report.filters'), 'closed' => true]); ?>
        ...
        <div class="col-md-2">
          <div class="form-group">
            <br>
            <label>
              <?php echo Form::checkbox('ecommerce', 1, false, ['class' => 'input-icheck', 'id' => 'ecommerce']); ?> <strong>Ecommerce</strong>
            </label>
          </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marcos/Documents/laravel_novo/ultimate/resources/views/product/index.blade.php ENDPATH**/ ?>
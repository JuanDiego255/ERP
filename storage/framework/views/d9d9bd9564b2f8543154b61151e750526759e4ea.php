                ...
                <th><?php echo e(__('home.total_sell'), false); ?>: <br>
                    ...
                    <ul>
                        <?php $__currentLoopData = $data['total_sell_by_subtype']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($data['total_sell_by_subtype']->count() > 1): ?>
                                <li>
                                    <?php if(!empty($sell->sub_type)): ?>
                                        <?php echo e(ucfirst($sell->sub_type), false); ?>
                            ...
                            <?php elseif($data['total_sell_by_subtype']->count() == 1 && !empty($sell->sub_type)): ?>
                                <li>
                                    <?php if(!empty($sell->sub_type)): ?>
                                        <?php echo e(ucfirst($sell->sub_type), false); ?>
...
<div class="col-xs-12">
    <?php $__env->startComponent('components.widget'); ?>
        ...
        <small class="help-block">(<?php echo app('translator')->get('report.closing_stock'); ?> + <?php echo app('translator')->get('home.total_sell'); ?> + <?php echo app('translator')->get('lang_v1.total_sell_shipping_charge'); ?> + <?php echo app('translator')->get('report.total_stock_recovered'); ?> + <?php echo app('translator')->get('lang_v1.total_purchase_return'); ?> + <?php echo app('translator')->get('lang_v1.total_purchase_discount'); ?> + <?php echo app('translator')->get('lang_v1.total_sell_round_off'); ?> 
        <?php $__currentLoopData = $data['right_side_module_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!empty($module_data['add_to_net_profit'])): ?>
                + <?php echo e($module_data['label'], false); ?> 
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ) <br> - (<?php echo app('translator')->get('report.opening_stock'); ?> + <?php echo app('translator')->get('home.total_purchase'); ?> + <?php echo app('translator')->get('report.total_expense'); ?> + <?php echo app('translator')->get('lang_v1.total_purchase_shipping_charge'); ?> + <?php echo app('translator')->get('lang_v1.total_transfer_shipping_charge'); ?> + <?php echo app('translator')->get('lang_v1.total_sell_discount'); ?> + <?php echo app('translator')->get('lang_v1.total_reward_amount'); ?> 
        <?php $__currentLoopData = $data['left_side_module_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!empty($module_data['add_to_net_profit'])): ?>
                + <?php echo e($module_data['label'], false); ?>
    ...
    <?php echo $__env->renderComponent(); ?>
</div><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/report/partials/profit_loss_details.blade.php ENDPATH**/ ?>
...
<section class="content no-print">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => 'Productos']); ?>
			...
			<div class="box <?php if(!empty($class)): ?> <?php echo e($class, false); ?> <?php else: ?> box-primary <?php endif; ?>" id="accordion">
				...
				<div id="collapseDesconto" class="panel-collapse active collapse" aria-expanded="true">
					<div class="box-body">
						...
						<div class="col-md-4">
							<div class="form-group">
								<?php echo Form::label('discount_type', 'Tipo de descuento*' ); ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<?php echo Form::label('shipping_details', 'Detalles del envío'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/sell/create.blade.php ENDPATH**/ ?>
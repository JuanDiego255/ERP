...
$(document).ready( function(){
    ...
    supplier_stock_report_table = $('#supplier_stock_report_table').DataTable({
        ...
        serverSide: true,
        'ajax': {
            url: "<?php echo e(action('ContactController@getSupplierStockReport', [$id]), false); ?>",
            data: function (d) {
...
$(document).on('click', '#send_ledger', function() {
    ...
    var url = "<?php echo e(action('NotificationController@getTemplate', [$id, 'send_ledger']), false); ?>" + '?start_date=' + start_date + '&end_date=' + end_date;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StoreWeb\resources\views/contact/show.blade.php ENDPATH**/ ?>